...
resumeRouter.post("/generate-summary",authMiddleware,generateSummaryController);
resumeRouter.post("/generate-project-description",authMiddleware,generateProjectDescriptionController);
...
resumeRouter.get("/:id/job-matches",authMiddleware,getJobMatchHistoryController);
resumeRouter.delete("/job-match/:jobMatchId",authMiddlewaredeleteJobMatchController);
resumeRouter.get("/job-match/:jobMatchId",authMiddleware,getJobMatchByIdController);
